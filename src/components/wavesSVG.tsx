  ...
  useEffect(() => {
    if (pathRef.current) {
      anime({
        ...
        d: [
            {value: 'M 0 0 L 0 902.17 Q 237.75 609.25 475.5 584.98 T 951 413.48 T 1426.5 249.35 T 1902 62.27 L 1902 0 Z'},
            {value: 'M 0 0 L 0 851.924 Q 237.75 607.503 475.5 561.752 T 951 470.72 T 1426.5 250.382 T 1902 -36.7969 L 1902 0 Z'},
            {value: 'M 0 0 L 0 872.345 Q 237.75 677.095 475.5 647.655 T 951 430.36 T 1426.5 272.055 T 1902 101.7 L 1902 0 Z'},
            {value: 'M 0 0 L 0 754.443 Q 237.75 663.446 475.5 634.592 T 951 445.368 T 1426.5 300.869 T 1902 18.1241 L 1902 0 Z'},
        ],
